...
class TabLink {
  ...
  select() {
    ...
    Array.from(links).forEach(allLinks => allLinks.classList.remove('tabs-link-selected'));
...
class TabItem {
  ...
  select() {
    ...
    Array.from(items).forEach(allElements => allElements.classList.remove('tabs-item-selected'));
